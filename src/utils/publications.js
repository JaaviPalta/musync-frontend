...
export const PUBLICATION_TYPE_OPTIONS = [
  {
    ...
    label: 'Música',
    helper:
      'Para tus canciones, remixes o EPs. Si pegas un link de Spotify o YouTube, queda reproducible directo en tu página, sin que nadie tenga que salir de ahí.',
  },
  {
    code: 'digital_product',
    label: 'Producto digital',
    helper:
      'Para algo descargable que vendes: packs de samples, presets, plantillas, stems. Aparece en tu tienda y se puede comprar directo desde tu página.',
  },
  {
    code: 'service',
    label: 'Servicio',
    helper:
      'Para lo que ofreces como trabajo: producción, mezcla, clases, sesiones. Puedes dejarlo con precio fijo o a cotizar, según el caso.',
  },
  {
    code: 'portfolio',
    label: 'Portafolio',
...
// Para mostrar mientras se escribe en el input de precio (sin el "$", eso
// ya lo dice el label "Precio (CLP)"). "" en vez de "0" para que el campo
// se vea vacío en vez de mostrar un cero forzado.
